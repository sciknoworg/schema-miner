...
if __name__ == "__main__":
    ...
    schema = extract_schema_stage1(save_schema=True)
    if schema is None:
    ...
    schema = extract_schema_stage2(schema, expert_review, scientific_paper, save_schema=True)
    if schema is None:
    ...
    schema = extract_schema_stage3(schema, expert_review, scientific_paper, save_schema=True)
